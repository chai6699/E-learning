...
""".format(otp)
    ...
    server.login('chaithanya6699@gmail.com', 'jpub mbmp smqt dfmh')
...
def send_new_course_email( email_content):
    email_address = 'chaithanya6699@gmail.com'  # Your Gmail email address
    app_password = 'jpub mbmp smqt dfmh'  # Your app-specific password
